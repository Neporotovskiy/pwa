...
type Props = {
  selected: Descriptor[];
  onSelect: (selected: Descriptor) => void;
};

export const FrontProjection = ({ selected, onSelect }: Props) => {
  const select = useCallback(
    ({ target, currentTarget }: PointerEvent<SVGGElement>) => {
      ...
      onSelect({
        locator: {
          region: regionNode.getAttribute('id')!,
          subregion: subregionNode.getAttribute('id')!,
        },
      });
    },
    [onSelect],
  ...
  const isSelected = (region: string, subregion: string) =>
    selected.some(
      (descriptor) =>
        descriptor.locator.region === region && descriptor.locator.subregion === subregion,
    );
    ...
    >
      <g id="Левая нога" onPointerDown={select}>
        <path
          ...
          data-selected={isSelected('Левая нога', 'Бедро')}
        ...
        <path
          id="Колено"
          className={styles.subregion}
          data-selected={isSelected('Левая нога', 'Колено')}
        ...
        <path
          id="Голень"
          className={styles.subregion}
          data-selected={isSelected('Левая нога', 'Голень')}
        ...
        <path
          id="Стопа"
          className={styles.subregion}
          data-selected={isSelected('Левая нога', 'Стопа')}
      ...
      <g id="Правая нога" onPointerDown={select}>
        <path
          id="Бедро"
          className={styles.subregion}
          data-selected={isSelected('Правая нога', 'Бедро')}
        ...
        <path
          id="Колено"
          className={styles.subregion}
          data-selected={isSelected('Правая нога', 'Колено')}
        ...
        <path
          id="Голень"
          className={styles.subregion}
          data-selected={isSelected('Правая нога', 'Голень')}
        ...
        <path
          id="Стопа"
          className={styles.subregion}
          data-selected={isSelected('Правая нога', 'Стопа')}
      ...
      <g id="Левая рука" onPointerDown={select}>
        <path
          id="Плечо"
          className={styles.subregion}
          data-selected={isSelected('Левая рука', 'Плечо')}
        ...
        <path
          id="Предплечье"
          className={styles.subregion}
          data-selected={isSelected('Левая рука', 'Предплечье')}
        ...
        <path
          id="Кисть"
          className={styles.subregion}
          data-selected={isSelected('Левая рука', 'Кисть')}
      ...
      <g id="Правая рука" onPointerDown={select}>
        <path
          id="Плечо"
          className={styles.subregion}
          data-selected={isSelected('Правая рука', 'Плечо')}
        ...
        <path
          id="Предплечье"
          className={styles.subregion}
          data-selected={isSelected('Правая рука', 'Предплечье')}
        ...
        <path
          id="Кисть"
          className={styles.subregion}
          data-selected={isSelected('Правая рука', 'Кисть')}
      ...
      <path
        id="Голова"
        className={styles.subregion}
        data-selected={isSelected('Голова', 'Голова')}
      ...
      <path
        id="Шея"
        className={styles.subregion}
        data-selected={isSelected('Шея', 'Шея')}
        onPointerDown={select}
      ...
      <g id="Туловище" onPointerDown={select}>
        <path
          id="Грудь"
          className={styles.subregion}
          data-selected={isSelected('Туловище', 'Грудь')}
        ...
        <path
          id="Живот"
          className={styles.subregion}
          data-selected={isSelected('Туловище', 'Живот')}
        ...
        <path
          id="Пах"
          className={styles.subregion}
          data-selected={isSelected('Туловище', 'Пах')}
